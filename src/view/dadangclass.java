...
import kontrolimplementasi.kelasdadang;
 ...
 * @author microsoft
 */
public class dadangclass extends javax.swing.JFrame {
    List <model> record = new ArrayList<>();
    Interface dadangservice;
    int row;

    /**
     * Creates new form dadangclass
     */
    public dadangclass() {
        initComponents();
        dadangservice = new kelasdadang();
        this.refresdata();
    }
    private void baru(){
...
isitabel();
    ...
    private void jBTN_HAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTN_HAPUSActionPerformed
        ...
        // if(id.trim().equals("") && nama.trim().equals("")){
            ...
            //}else{
            try {
                dadangservice.hapus(jTBL_Teman.getValueAt(row, 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dadangclass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dadangclass().setVisible(true);
            }
        });
    }
